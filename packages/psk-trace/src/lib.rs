...
//!
//! WP04 (I5): `trace` (TraceSegment, Struktur 7.39 - hashverkettetes,
//! ausschliesslich anhaengendes Log, Invariante 4.8), `residue`
//! (ResidueRecord, Struktur 7.42 - Axiom 7.43 No Silent Loss), `run`
//! (RunDescriptor Struktur 7.44, ReplayManifest Struktur 22.5 - C11 wird
