//! M19 TraceReplayResidueStore, Residuenteil (Struktur 7.42, OBJ-RES).
//!
//! Axiom 7.43 (No Silent Loss), woertlich: "Jede Nichtclosure erzeugt
...
/// Loeschung ist mit dieser API nicht ausdrueckbar (Axiom 7.43).
///
...
/// sich Axiom 7.43 (kein stilles Verwerfen) durch das Einspielen eines
...
/// `segment_record_digest` (Regel 7.40): `can()` ohne pi_vol, `opened_at`
...
mod tests {
    ...
    fn there_is_no_way_to_remove_a_residue() {
        // Axiom 7.43: strukturelle Abwesenheit einer Loeschmethode ist der
