...
//! Gate, Invariante 20.4 (Kein Effekt ohne Token); Idempotenzschluessel aus [run_id, port_id, seq]),
...
//!
//! Boot-Realisierung (Algorithmus 17.1 (Boot), Schritt 17): `registration`
...
mod boundary;
pub use boundary::{execute_effect, EffectAdapter, EffectLines, NoEffectLines};
