//! M17 ExternalRecordIngress, ExternalReceipt-Teil (Struktur 7.36 (EffectAttempt / ExternalReceipt), P24).
//!
...
/// Beobachtungsergebnisses (Struktur 7.36 (EffectAttempt / ExternalReceipt): "record: bytes # unveraendert,
/// unvermischt").
...
/// (psk-effect, Struktur 7.36 (EffectAttempt / ExternalReceipt)) - ein M16/M15-Typ, den psk-anchor nicht
