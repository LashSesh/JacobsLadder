...
//! ```
//!
//! Vertrag 7.29 (Kein halluziniertes Gluing) und Invariante 11.14
...
/// benannt, aber nicht ausgeschrieben - Struktur 7.21 (CandidateCapsule)
...
/// Ueberlappungsbereich U und erzeugt den SeamReport (Struktur 7.28).
///
...
/// das halluzinierte Gluing, das Vertrag 7.29 verbietet.
...
/// WP04 (Phase I5) und existiert noch nicht; das Feld ist in Struktur 7.28
...
mod tests {
    ...
    fn tolerance_class_is_never_silently_declared_equivalent() {
        // Vertrag 7.29 (Kein halluziniertes Gluing): ohne deklarierte
