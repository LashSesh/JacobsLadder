...
//! ```
//!
//! Vertrag 7.32 (Kein halluziniertes Gluing) und Invariante 11.14 (Eindeutigkeit der Verklebung):
...
/// Ueberlappungsbereich U und erzeugt den SeamReport (Struktur 7.31 (SeamReport / ObstructionRecord)).
///
...
/// das halluzinierte Gluing, das Vertrag 7.32 (Kein halluziniertes Gluing) verbietet.
...
/// WP04 (Phase I5) und existiert noch nicht; das Feld ist in Struktur 7.31 (SeamReport / ObstructionRecord)
...
mod tests {
    ...
    fn tolerance_class_is_never_silently_declared_equivalent() {
        // Vertrag 7.32 (Kein halluziniertes Gluing): ohne deklarierte
