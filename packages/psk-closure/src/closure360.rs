//! Definition 9.11 (360-Grad-Closure), Definition 9.12 (720-Grad-Closure),
//! Invariante 9.15 (Keine Halbschliessung).
//!
//! ```text
...
//! 9.11/9.12 gegebene Verknuepfungsformel ueber bereits vorliegende Evidenz
//! ausgewertet - das ist woertliche Umsetzung der Definition, nicht eine
//! Annaeherung an sie.

use psk_types::Digest;

/// Evidenz fuer Definition 9.11: die bereits andernorts (M09/M10)
...
/// Definition 9.11 woertlich: pi(Phi(x)) = pi(x) und Seam(Phi,x) = 1.
pub fn close360(e: &Close360Evidence) -> bool {
    e.projected_lensed == e.projected_source && e.seam_ok
}

/// Evidenz fuer Definition 9.12: die bereits andernorts (M09/M19)
...
pub struct Close720Evidence {
    ...
    /// Hol(Phi^2) == I (Identitaetstransport, Definition 9.13).
    pub holonomy_is_identity: bool,
    /// Replay(Phi^2) ==can x.
    pub replay_canon_eq: bool,
}

/// Definition 9.12 woertlich: alle drei Bedingungen zugleich.
pub fn close720(e: &Close720Evidence) -> bool {
    e.double_lensed_canon_eq && e.holonomy_is_identity && e.replay_canon_eq
}

/// Vertrag 9.14 (Semantische Rueckkehr): eine geschlossene Atlasroute ist
...
/// Vertrag 9.14: semantisch geschlossen, sofern eine der drei benannten
...
pub struct ClosureReport {
    pub close360: bool,
    pub close720: bool,
    /// Invariante 9.15 (Keine Halbschliessung): Close360(x)=1 impliziert
...
/// 9.11/9.12) und bildet daraus den ClosureReport (Invariante 9.15:
...
mod tests {
    ...
    #[test]
    fn semantic_return_accepts_the_named_vertrag_9_14_classes_only() {
