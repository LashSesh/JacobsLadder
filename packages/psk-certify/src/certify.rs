...
//!
//! Regel 7.53 (plattformgebundeneverpflichtungsaufloesungimzertifikat) (Plattformgebundene Verpflichtungsaufloesung im Zertifikat,
...
/// sie sind Regel 7.53 (plattformgebundeneverpflichtungsaufloesungimzertifikat)s Gegenstand nicht.
pub struct ObligationPlatformBinding {
    ...
    /// bedeutet: blockiert keine Klasse, fuer Regel 7.53 (plattformgebundeneverpflichtungsaufloesungimzertifikat) ohne Wirkung.
...
/// Regel 7.53 (plattformgebundeneverpflichtungsaufloesungimzertifikat), wortgetreu umgesetzt: fuer jede plattformgebundene
...
pub struct CertificateInputs {
    ...
    /// `std::env::consts::OS`) - Regel 7.53 (plattformgebundeneverpflichtungsaufloesungimzertifikat) vergleicht sie gegen jede
...
/// wenn Vertrag 22.4 (Replayklasse des Referenzrelease), mindestens R2 verletzt ist, oder wenn Regel 7.53 (plattformgebundeneverpflichtungsaufloesungimzertifikat)
...
mod tests {
    ...
    // Regel 7.53 (plattformgebundeneverpflichtungsaufloesungimzertifikat): OBL-010-artige plattformgebundene
    ...
    fn c4_on_a_fictional_foreign_platform_is_refused() {
        ...
        // werden, sondern die Ausstellung selbst ablehnen (Regel 7.53 (plattformgebundeneverpflichtungsaufloesungimzertifikat):
