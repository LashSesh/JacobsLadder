//! M21 CertificateReleaseEngine (Kapitel 23, Struktur 7.48).
//!
...
//!
//! `MachineCertificate` (Struktur 7.48) hat - anders als jedes andere
...
//!
//! Regel 7.49 (Plattformgebundene Verpflichtungsaufloesung im Zertifikat,
...
/// sie sind Regel 7.49s Gegenstand nicht.
pub struct ObligationPlatformBinding {
    ...
    /// bedeutet: blockiert keine Klasse, fuer Regel 7.49 ohne Wirkung.
...
/// Regel 7.49, wortgetreu umgesetzt: fuer jede plattformgebundene
...
pub struct CertificateInputs {
    ...
    /// `std::env::consts::OS`) - Regel 7.49 vergleicht sie gegen jede
...
/// wenn Vertrag 22.2 (mindestens R2) verletzt ist, oder wenn Regel 7.49
...
mod tests {
    ...
    // Regel 7.49 (PSK-RA v1.0.17): OBL-010-artige plattformgebundene
    ...
    fn c4_on_a_fictional_foreign_platform_is_refused() {
        ...
        // werden, sondern die Ausstellung selbst ablehnen (Regel 7.49:
