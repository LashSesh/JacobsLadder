...
/// wenn Vertrag 22.5 (Replayklasse des Referenzrelease), mindestens R2 verletzt ist, oder wenn Regel 7.56 (Plattformgebundene Verpflichtungsauflösung im Zertifikat)
/// nicht erfuellt ist.
