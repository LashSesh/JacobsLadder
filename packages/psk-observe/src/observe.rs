//! M27 ObservabilityProjector (Axiom 7.20, Struktur 7.1 Speicherklasse
//! `none`).
//!
...
//!
//! Axiom 7.20 (Persona ist Apertur): "Eine Persona DARF Stil,
...
/// Axiom 7.20: "Stil, Dialogkontinuitaet oder menschliche Lesbarkeit" -
