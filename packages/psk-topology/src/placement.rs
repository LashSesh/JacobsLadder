...
/// k-Werte (fuer den CellReport-Vermerk, Regel 9.13 letzter Satz).
...
/// k0 = H(Can(node)) mod 6 (Regel 9.13 Punkt 5).
...
/// Regel 9.13: platziert `node` deterministisch in eine M13Address.
...
mod tests {
    ...
    fn identity_context_and_branch_map_to_center() {
        // Regel 9.13 Punkt 1: S-IDT, S-CTX, S-BRN -> Delta_c.
    ...
    fn cell_bound_sort_uses_context_cell_verbatim() {
        // Regel 9.13 Punkt 4: S-WIT ist zellgebunden, nicht frei platzierbar.
