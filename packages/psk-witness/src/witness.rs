...
/// Eingaben fuer ein EvidenceObject (Struktur 7.25). `hash` und `id` fehlen:
...
pub struct EvidenceInputs {
    ...
    /// "aus DependencyProfile abgeleitet" (Struktur 7.25). Nicht frei
...
///
/// Struktur 7.25 sagt zu `independence_class` nur "aus DependencyProfile
