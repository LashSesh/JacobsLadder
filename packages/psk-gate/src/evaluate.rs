...
//! ueber M13Address-Zellen arbeitet, Struktur 7.31 (SeamReport / ObstructionRecord)). Definition 18.2 spricht
...
pub fn evaluate_gate(
    ...
    if inputs.order == 2 && inputs.seam_report_refs.is_empty() {
        // Struktur 7.33 (GateReport): "seam_report_refs: [ObjectId] # Pflicht bei order = 2".
...
mod tests {
    ...
    fn false_condition_fails_and_stops_immediately() {
        ...
        // Beide vorherigen Gruende bleiben erhalten (Axiom 7.45 (No Silent Loss)-artig: nichts
