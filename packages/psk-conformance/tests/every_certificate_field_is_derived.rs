//! Regel 7.54 (Plattformgebundene Verpflichtungsauflösung im Zertifikat), feldweise.
//!
...
fn assert_not_a_known_constant(field: &str, value: Digest) {
    for (name, c) in banned_constants() {
        assert_ne!(
            value, c,
            "{field} traegt die Konstante sha256(\"{name}\") - Regel 7.54 (Plattformgebundene Verpflichtungsauflösung im Zertifikat) verletzt"
        );
    }
...
/// Regel 7.54 (Plattformgebundene Verpflichtungsauflösung im Zertifikat) Punkt 1: "I_C, I_A, I_M sind die Werte der IdentityBinding
...
/// Regel 7.54 (Plattformgebundene Verpflichtungsauflösung im Zertifikat) Punkt 2: "I_t ist H(Can(Sigma_t)) NACH DEN TAKTEN."
#[test]
...
/// Regel 7.54 (Plattformgebundene Verpflichtungsauflösung im Zertifikat) Punkt 3: "die vier Berichtsdigests sind Digests der
...
/// Regel 7.54 (Plattformgebundene Verpflichtungsauflösung im Zertifikat) Punkt 4: "feature_coverage ist ABGELEITET, nicht
...
/// Regel 7.54 (Plattformgebundene Verpflichtungsauflösung im Zertifikat) Punkt 5: "trace_head ist der Kopf der KETTE DIESES LAUFES."
#[test]
...
/// beansprucht C0. Vertrag 7.55 (Selbstgültigkeit) verlangt die Signatur
